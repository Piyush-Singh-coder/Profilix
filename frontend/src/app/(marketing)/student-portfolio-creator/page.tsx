...
export const metadata: Metadata = {
  title:
    "Portfolio Card Builder for Students & Bootcamp Graduates – Get Hired Faster",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Portfolio Card Builder for Students",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Format your projects and GitHub into a professional portfolio card. Perfect for getting your first tech role.",
      ...
      <section className="py-24 bg-surface-low border-b border-border/50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface border border-border text-sm text-text-secondary mb-6 font-medium">
            <GraduationCap className="w-4 h-4 text-green-500" /> Made for
            Students
          </div>
          ...
          <p className="text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
            Land your first internship or junior dev role. Profilix
            automatically formats your student projects, hackathon wins, and
            GitHub activity into a professional card and ATS-ready resume.
          </p>
          <div className="flex justify-center">
            <Link href="/dashboard/qr">
              <Button size="lg" className="rounded-full px-8 py-6 text-lg">
                <GraduationCap className="w-5 h-5 mr-2" /> Create your portfolio
                card
              </Button>
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center group">
            ...
            <h3 className="text-xl font-bold font-heading mb-3 text-text-primary">
              1-Click Resume Export
            </h3>
            <p className="text-text-secondary">
              Stop struggling with Word templates. Export your profile instantly
              to an ATS-friendly PDF or DOCX file structured perfectly for
              recruiters.
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-text-secondary">
              No professional experience yet? No problem. Highlight your top
              academic projects, hackathons, and personal repositories front and
              center.
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-text-secondary">
              Most students just hand over a disorganized GitHub link. You'll
              hand over a beautiful, trackable digital portfolio card that
