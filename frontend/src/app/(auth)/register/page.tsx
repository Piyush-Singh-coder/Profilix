...
export default function RegisterPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-text-secondary">Launch your portfolio workspace in minutes.</p>
      ...
      <div className="my-7 flex items-center gap-3">
        ...
        <span className="text-xs uppercase tracking-[0.18em] text-text-secondary">Or register</span>
        <div className="h-px flex-1 bg-border" />
      </div>
      ...
      <p className="mt-7 text-center text-sm text-text-secondary">
        ...
        <Link href="/login" className="ml-2 font-semibold text-primary transition-opacity hover:opacity-85">
          Sign in
        </Link>
      </p>
    </div>
