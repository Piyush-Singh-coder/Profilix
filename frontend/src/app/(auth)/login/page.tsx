...
export default function LoginPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-text-secondary">Sign in to continue building your portfolio.</p>
      ...
      <div className="my-7 flex items-center gap-3">
        ...
        <span className="text-xs uppercase tracking-[0.18em] text-text-secondary">Or email</span>
        <div className="h-px flex-1 bg-border" />
      </div>
      ...
      <p className="mt-7 text-center text-sm text-text-secondary">
        New here?
        <Link href="/register" className="ml-2 font-semibold text-primary transition-opacity hover:opacity-85">
          Create account
        </Link>
      </p>
    </div>
